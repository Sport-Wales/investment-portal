    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm">
        ...
        <div className="p-6 space-y-6">
          <FormField
            label="Expectations"
            helpText="Areas for the partner to aim to complete throughout the term of the offer letter"
          >
            <textarea
          ...
          <FormField
            label="Conditions"
            helpText="Areas to be completed within the specified timeframe for investment release"
          >
            <textarea
