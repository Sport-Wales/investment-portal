...
const CapabilityFramework = () => {
    ...
    const calculateOverallStats = () => {
      let met = 0, notMet = 0, needsHelp = 0, total = 0;
      ...
      capabilityFrameworkData.principles.forEach(principle => {
        ...
        allRequirements.forEach(req => {
          ...
          if (status === 'met') met++;
          if (status === 'not-met') notMet++;
          if (status === 'need-help') needsHelp++;
        });
      });
    
      return { met, notMet, needsHelp, total };
    };
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  >
                    ...
                    <option value="need-help">Request Additional Help</option>
                  </select>
                </FormField>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 my-6">
          ...
          <div className="flex justify-around items-center">
            {[
              { key: 'met', label: 'Requirements Met', icon: CheckCircle, color: 'text-green-600', bg: 'bg-green-50' },
              { key: 'notMet', label: 'Not Met', icon: AlertCircle, color: 'text-red-600', bg: 'bg-red-50' },
              { key: 'needsHelp', label: 'Help Needed', icon: HelpCircle, color: 'text-amber-600', bg: 'bg-amber-50' }
