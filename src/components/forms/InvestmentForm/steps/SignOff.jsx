// src/components/forms/InvestmentForm/steps/SignOff.jsx
import React, { useState } from 'react';
import { useForm } from '../../../../context/FormContext';
import FormField from '../shared/FormField';
import {  Calendar, AlertCircle, CheckCircle2 } from 'lucide-react';
// need to replace icon Filepen 
    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <div className="flex items-start space-x-3 mb-6">
          {/* <FilePenLine className="h-6 w-6 text-sw-blue flex-shrink-0" /> */}
          <div>
      ...
      <div className="bg-blue-50 rounded-lg p-6">
        <div className="flex items-start space-x-3">
          <CheckCircle2 className="h-6 w-6 text-sw-blue flex-shrink-0" />
          <div>
            ...
            <div className="mt-2 text-sm text-gray-600">
              ...
              <ul className="mt-2 space-y-2">
                <li className="flex items-center">
                  ...
                  Your application will be reviewed by Sport Wales staff
                </li>
                <li className="flex items-center">
                  <span className="h-1.5 w-1.5 rounded-full bg-sw-blue mr-2"></span>
                ...
                <li className="flex items-center">
                  <span className="h-1.5 w-1.5 rounded-full bg-sw-blue mr-2"></span>
                  Allow up to 5 working days for initial response
                </li>
                <li className="flex items-center">
                  <span className="h-1.5 w-1.5 rounded-full bg-sw-blue mr-2"></span>
